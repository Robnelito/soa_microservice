                    ...
                    clients.length > 0 && clients != null ? (
                        ...
                        <>
                            <div className='flex justify-center items-center mt-52'>
                                <p className='bg-gradient-to-br from-gray-800 via-gray-600 to-gray-800 text-white p-4 rounded text-md'>Il n&#39;y a aucune donnée disponible !</p>
                            </div>
                        </>
                    )
                }
