    ...
    return (
        <div className='relative mt-5'>
            <table className='table-fixed w-[100%] 2xl:w-[100%] border-separate'>
                <thead className='sticky top-0 z-10 space-x-8 bg-slate-400 h-[50px] place-items-center font-semibold px-4 rounded-md'>
                    <tr>
                        <th className='space-x-2 w-[300px] border border-slate-400 rounded-md text-slate-50 uppercase tracking-wider'>Catégorie Fourniture</th>
                        <th className='space-x-2 w-[150px] place-items-center border border-slate-400 rounded-md text-slate-50 uppercase tracking-wider'>Action</th>
                    </tr>
                </thead>
                <tbody>
                    {/* {data.length > 0 && data != null ? (
                        data.map((categoriefourniture) => (
                            <> */}
                                <tr className='z-1 w-[100%] space-x-8 h-[50px] place-items-center px-4 rounded-md'>
                                    <td className='text-center space-x-2 w-[300px] border border-slate-300 rounded-md space-y-4'>test</td>
                                    <td className='text-center space-x-2 w-[150px] border border-slate-300 rounded-md'>
                                        <div className='flex justify-center place-content-center space-x-2'>
                                            <button className="flex space-x-2 bg-red-500 hover:bg-yellowy-700 font-semibold py-2 px-4 rounded-lg">
